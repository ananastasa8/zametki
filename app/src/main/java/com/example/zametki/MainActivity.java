...
public class MainActivity extends AppCompatActivity {
    ...
    public void AddNote(View view){
        ...
        new_notes.date = e_text.getText().toString();

        Date dateMow = new Date();
        SimpleDateFormat formatForDateNow = new SimpleDateFormat("yyyy.MM.dd");
        new_notes.date = formatForDateNow.format(dateMow);
    ...
    public void onLoad(){
        ...
        for(int i=0; i< list_nites.size(); i++){
            ...
            ll.setTag(i);
            ll.setOnClickListener(this::OpenNote);

            ImageView iv = new ImageView(this);
            iv.setImageResource(R.drawable._f4c1);
